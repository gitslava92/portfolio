  ...
  ru: {
    translation: {
      ...
      "Experiense.FourthWork.Text":
        "Работа в команде, по созданию комплексной высоконагруженной платформы учета и передачи информации (маркетплейс). рабочие процессы строились на базе SCRUM (спринты) и GitFlow. ||Разрабатывал и принимал участи практически во всех частях проекта: роутинг (React Router), авторизация (jwt), сложные многостраничные формы (react-hook-form), чаты и уведомления о событиях (на основе mattermost api и webSocket), таблицы (TanStack Table), стилизация на основе MaterialUI, Styled Components, анимации (React Spring). Проект представляет собой множеством сложных сущностей: офферы, отклики, сделки, платежи, отзывы, рейтинги, споры, чаты, валюты, кошельки, а также администрирование всего этого. Также наполнял storybook, писал тесты на Vitest. ||Использовал: Typescript, ReactJS, HTML, CSS, SASS, MaterialUI 5, Styled Components, Reaact Hook Form, TanStack Table, ReactSpring, GraphQl, Apollo, WebSocket, Git, Docker, Vite, StoryBook, Vitest ||Pet project: редактор CSV файлов. Самостоятельно разработал приложение на electron + rect + mui. Автоматическая, специфическая обработка и валидация csv файлов.",
