export const en = {
  en: {
    translation: {
      ...
      "Experiense.FourthWork.Text": "Teamwork to create a comprehensive high-load platform for accounting and information transfer (marketplace). Workflows were based on SCRUM (sprints) and GitFlow. ||I have developed and participated in almost all parts of the project: routing (React Router), authorization (jwt), complex multi-page forms (react-hook-form), chats and event notifications (based on mattermost api and WebSocket), tables (TanStack Table), stylization based on MaterialUI, Styled Components, animations (React Spring). The project consists of many complex entities: offers, responses, transactions, payments, reviews, ratings, disputes, chats, currencies, wallets, as well as the administration of all this. I also filled the storybook, wrote tests for Vitest. ||Used: Typescript, ReactJS, HTML, CSS, SASS, MaterialUI 5, Styled Components, Reaact Hook Form, TanStack Table, ReactSpring, GraphQL, Apollo, WebSocket, Git, Docker, Vite, StoryBook, Vitest ||Pet project: CSV file editor. I independently developed an application on electron + rect + mui. Automatic, specific processing and validation of csv files.",
